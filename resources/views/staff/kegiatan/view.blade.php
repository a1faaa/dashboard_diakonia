                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control format-number" name="kegiatan_nominal"
                                id="kegiatan_nominal"
                                value="{{ number_format($kegiatan['kegiatan_nominal'], 0, ',', '.') }}" disabled>
                        </div>
                    </div>
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <?php
                                ...
                                ?>
                            <a href="{{ $fileUrl }}" class="btn btn-success mb-1" download>Unduh</a>
                            <?php
                                    }else{
                                        echo '-';
                                    }
                    ...
                    <div class="row mb-3">
                        <div class="col-12">
                            <a class="btn btn-secondary float-start"
                                href="{{ route('master.kegiatan.filter', [$kegiatan['proker_id']]) }}">Kembali</a>
                        </div>
                    </div>
                </div>
            </div>
